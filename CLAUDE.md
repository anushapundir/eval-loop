...
- **Next:** Day 5 — experiment tracking, metrics aggregation (`reports/metrics.py`), comparison + charts (`reports/charts.py`: score trend, v1-vs-v2, per-criterion, failure modes), and an optional regression gate across prompt-level iterations.
